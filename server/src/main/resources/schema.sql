...
CREATE TABLE IF NOT EXISTS comment (
  ...
  CONSTRAINT fk_comment_event FOREIGN KEY (event_id) REFERENCES PUBLIC.event(event_id) ON DELETE CASCADE ON UPDATE RESTRICT,
  CONSTRAINT fk_comment_user FOREIGN KEY (author_id) REFERENCES PUBLIC.users(user_id) ON DELETE CASCADE ON UPDATE RESTRICT
);